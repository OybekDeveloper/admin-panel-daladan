...
import { DeleteModalData, EditModalData, ShowSelectFaq } from '../../reducer/events';
import { useDispatch, useSelector } from 'react-redux';
import { edit, trash } from '../category/category-img';
const FaqItem = ({ faq }) => {
    const dispatch = useDispatch()
    const { modalCreate, modalDel, modalEdit } = useSelector(state => state.events)
        ...
        <div className='relative justify-start w-full faq-card flex flex-col items-start gap-[8px]'>
            <div className='w-full flex justify-between items-start  gap-[8px]'>
                ...
                <motion.div
                    ...
                    <div onClick={() => { }} className='opacity-[0.5] cursor-pointer flex gap-[8px] p-[10px]'>
