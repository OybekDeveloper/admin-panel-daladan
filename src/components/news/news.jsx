    ...
    return (
        <div className="news px-[24px] py-[32px] w-full">
            <section className="flex justify-between items-center">
                ...
                <div onClick={handleCreateNews} className="add-news flex justify-center items-center gap-[6px] px-[14px] py-[10px] cursor-pointer">
                ...
                {news
                    ...
                    .map((item) => (
                        ...
                        >
                            ...
                            <button onClick={() => handleShowAllNews(item.id)} className="news-btn h-[30px] rounded-[12px] mt-[10px] bg-[#eff0f1] hover:bg-[#ecedee]">
                                Batafsil
                            </button>
