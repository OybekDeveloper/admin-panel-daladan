...
const CreateModal = () => {
    ...
    const [bannerCreateData, setBannerCreatetData] = useState({ url: "empty" });
    ...
    const handleFileUploaded = (e) => {
        ...
        uploadBytes(imgRef, file)
            ...
            .then((url) => {
                setBannerCreatetData({ ...bannerCreateData, imageUrl: url })
            })
            .catch((error) => {
    ...
    const handleClose = () => {
        ...
        setIsLoading(true)
        setBannerCreatetData(null)

    };
    useEffect(() => {
        if (bannerCreateData?.imageUrl && bannerCreateData?.url) setIsLoading(false);
    }, [bannerCreateData])
                            ...
                            <Dialog.Panel className=" rounded-[12px] bg-[#fff] shadow-modal">
                                <div className="w-[400px] p-[24px]">
                                    ...
                                    <p className="text-[14px] font-[400] text-[#475467] pt-[4px]">
                                        Banner qo’shish uchun quyidagi ma’lumotlarni to’ldiring
                                    </p>
